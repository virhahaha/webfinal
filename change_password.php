			...
			<div class="panel-body">
				<div class="row">
					<form class="form-horizontal"
						action="controller/changepassword_controller.php" method="post">

						<div class="form-group">

							<label class="col-lg-4 control-label" for="pwd_new">New Password:
							</label>
							<div class="col-lg-4">
								<input class="form-control" name="pwd_new" id="pwd_new"
						...
						<div class="form-group">
							...
							<label class="col-lg-4 control-label" for="pwd_again">Password
								again: </label>
							<div class="col-lg-4">
								<input class="form-control" name="pwd_again" id="pwd_again"
